    ...
    <div id="about-inte">
        <div class="container">
            <div class="section-title text-center center">
              <h2><span class="blanco-inte">{{ trans('integracion.about.title') }}</span></h2>
              <hr class="decoration integracion-line">
            </div>
            <div class="about-section">
                <div class="about-first">
                    <div class="about-img" :style="{backgroundImage: `url('/assets/www/images/about_us_inte.png')`}"></div>
                </div>
                <div class="about-second">
                    <div class="about-second-first-row">
                        <div class="about-first-text" v-html="trans('integracion.about.first-text')"></div>
                        <div class="about-second-text" v-html="trans('integracion.about.second-text')"></div>
                    </div>
